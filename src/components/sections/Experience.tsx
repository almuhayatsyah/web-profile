  ...
  const experiences = [
    {
      ...
      certificateName: "Sertifikat Magang - PT PLN UID ACEH",
      certificateFileName: "Sertifikat-PLN.jpg"
    }
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Pengalaman magang, proyek profesional, dan keahlian praktis saya
            </p>
          </motion.div>
                    ...
                    {experience.certificate && (
                      <div className="mt-6">
                        <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-4 flex flex-col items-center shadow">
                          <a href={experience.certificate} download={experience.certificateFileName}>
                            <img
                              src={experience.certificate}
                              alt={experience.certificateName}
